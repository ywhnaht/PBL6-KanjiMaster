      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform animate-scale-in">
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={handleClose}
            disabled={isCreating}
            className="flex-1 px-4 py-3 bg-gray-100 text-gray-700 font-semibold rounded-xl disabled:opacity-50"
          >
            Hủy
          </button>
          <button
            ...
            disabled={isCreating}
            className="flex-1 px-4 py-3 bg-gradient-to-r from-slate-500 to-rose-400 text-white font-semibold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
